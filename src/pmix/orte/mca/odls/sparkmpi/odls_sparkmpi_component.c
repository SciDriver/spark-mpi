...
#include "orte/mca/odls/sparkmpi/odls_sparkmpi.h"
...
orte_odls_base_component_t mca_odls_sparkmpi_component = {
    /* First, the mca_component_t struct containing meta information
    about the component itself */
    .version = {
        ORTE_ODLS_BASE_VERSION_2_0_0,
        /* Component name and version */
        .mca_component_name = "sparkmpi",
        MCA_BASE_MAKE_VERSION(component, ORTE_MAJOR_VERSION, ORTE_MINOR_VERSION,
                              ORTE_RELEASE_VERSION),

        /* Component open and close functions */
        .mca_open_component = orte_odls_sparkmpi_component_open,
        .mca_close_component = orte_odls_sparkmpi_component_close,
        .mca_query_component = orte_odls_sparkmpi_component_query,
    },
    .base_data = {
...
int orte_odls_sparkmpi_component_query(mca_base_module_t **module, int *priority)
{
     ...
     */
    *priority = 20; /* let others override us - we are the default */
    *module = (mca_base_module_t *) &orte_odls_sparkmpi_module;
    return ORTE_SUCCESS;
}
