...
/* spark-mpi: add includes for accessing orte_odls */
...
int orterun(int argc, char *argv[])
{
    ...
    /* spark-mpi: replace orte_odls_default_launch_local_procs */
    orte_odls.launch_local_procs = orte_odls_sparkmpi_launch_local_procs;
...
/* spark-mpi variant of odls_default_fork_local_proc  */
